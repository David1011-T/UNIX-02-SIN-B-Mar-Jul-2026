...
stat archivo.txt #This command shows info about the file like the size, the block, last time it was accessed, modified, changed and the time of birth/creation